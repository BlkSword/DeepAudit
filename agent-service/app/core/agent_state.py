...
class AgentState(BaseModel):
    ...
    agent_name: str = "CTX-Audit Agent"
    agent_type: str = "generic"  # orchestrator, recon, analysis, verification
    ...
    waiting_start_time: Optional[str] = None
    waiting_reason: str = ""
    ...
    def has_waiting_timeout(self) -> bool:
        ...
        try:
            start_time = datetime.fromisoformat(self.waiting_start_time)
