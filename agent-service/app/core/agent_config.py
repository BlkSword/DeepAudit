...
def get_agent_type_config(agent_type: str) -> AgentTypeConfig:
    ...
    agent_configs = {
        "orchestrator": AgentTypeConfig(
            ...
            tools=["dispatch_recon_agent", "rust_scan", "dispatch_analysis_agent",
                   "dispatch_verification_agent", "finish_audit"],
        ),
        ...
        "analysis": AgentTypeConfig(
            ...
            timeout_seconds=config.sub_agent_timeout_seconds,
            tools=["smart_scan", "pattern_match", "dataflow_analysis",
